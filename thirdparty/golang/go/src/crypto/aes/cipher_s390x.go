...
import (
	...
	"github.com/copperexchange/krypton-primitives/thirdparty/go/src/crypto/internal/alias"
)
...
var _ KeyedBlock = (*aesCipherAsm)(nil) // CUSTOM
...
func (c *aesCipherAsm) Clone() KeyedBlock {
	clonedCipher := &aesCipherAsm{
		function: c.function,
		key:      slices.Clone(c.key),
		storage:  c.storage,
	}
	return clonedCipher
}

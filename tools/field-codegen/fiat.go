...
func GenerateFiat(goPackage, goType string, mode Mode, modulus string) (fiatFileName string) {
	...
	if mode == MontgomeryMode {
		fiatContainerRequest.Cmd = []string{

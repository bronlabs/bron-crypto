...
pub type callback = ::std::option::Option<unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void)>;
extern "C" {
    pub fn call_later_go_cb(arg1: *mut ::std::os::raw::c_void);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Round2Output {
    pub broadcast: *mut ::std::os::raw::c_void,
    pub p2p: *mut ::std::os::raw::c_void,
}
#[test]
fn bindgen_test_layout_Round2Output() {
    const UNINIT: ::std::mem::MaybeUninit<Round2Output> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<Round2Output>(),
        16usize,
        concat!("Size of: ", stringify!(Round2Output))
    );
    assert_eq!(
        ::std::mem::align_of::<Round2Output>(),
        8usize,
        concat!("Alignment of ", stringify!(Round2Output))
    );
    assert_eq!(
...
fn bindgen_test_layout_Foo() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).participant) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(Foo),
...
extern "C" {
    pub fn DKG_FROST_CreateIdentity() -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn DKG_FROST_CreateCohortConfig(
        alice: *mut ::std::os::raw::c_void,
        bob: *mut ::std::os::raw::c_void,
        charlie: *mut ::std::os::raw::c_void,
    ) -> *mut ::std::os::raw::c_void;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct DKG_FROST_NewDKGParticipant_return {
    pub r0: *mut ::std::os::raw::c_void,
    pub r1: *mut ::std::os::raw::c_char,
}
#[test]
fn bindgen_test_layout_DKG_FROST_NewDKGParticipant_return() {
    const UNINIT: ::std::mem::MaybeUninit<DKG_FROST_NewDKGParticipant_return> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<DKG_FROST_NewDKGParticipant_return>(),
        16usize,
        concat!("Size of: ", stringify!(DKG_FROST_NewDKGParticipant_return))
    );
    assert_eq!(
        ::std::mem::align_of::<DKG_FROST_NewDKGParticipant_return>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(DKG_FROST_NewDKGParticipant_return)
        )
    );
    assert_eq!(
...
extern "C" {
    pub fn DKG_FROST_NewDKGParticipant(
        identityKeyP: *mut ::std::os::raw::c_void,
        cohortConfigP: *mut ::std::os::raw::c_void,
    ) -> DKG_FROST_NewDKGParticipant_return;
}
extern "C" {
    pub fn DKG_FROST_Round1(
        participantP: *mut ::std::os::raw::c_void,
    ) -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn DKG_FROST_Round2(
        participantP: *mut ::std::os::raw::c_void,
        player2P: *mut ::std::os::raw::c_void,
        player3P: *mut ::std::os::raw::c_void,
        player2Output: *mut ::std::os::raw::c_void,
        player3Output: *mut ::std::os::raw::c_void,
    ) -> Round2Output;
}
extern "C" {
    pub fn DKG_FROST_Round3(
        participantP: *mut ::std::os::raw::c_void,
        player2P: *mut ::std::os::raw::c_void,
        player3P: *mut ::std::os::raw::c_void,
        player2OutputBroadcastP: *mut ::std::os::raw::c_void,
        player3OutputBroadcastP: *mut ::std::os::raw::c_void,
        player2OutputP2PP: *mut ::std::os::raw::c_void,
        player3OutputP2PP: *mut ::std::os::raw::c_void,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn UnrefPointer(p: *mut ::std::os::raw::c_void);
}
extern "C" {
    pub fn UnrefString(ptr: *mut ::std::os::raw::c_char);
}

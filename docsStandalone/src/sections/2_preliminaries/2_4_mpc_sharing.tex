% ii. Sharing Module: [Mateusz]
% 1) Shamir
%     ® Mention additive share conversion
% 2) Feldman:
%     ® Used in trusted dealer
% 3) Pedersen:
%     ® Used in dkg
% 4) Zero share sampling:  [Alireza]
%     ® Source from DKLs and context to be used
% Mention it’s n-of-n and different from key refresh, with cite to the relevant key refresh discussed in dkg.
...
\begin{itemize}
    ...
    \input{src/algorithms/primitives/additive.tex}
    ...
    \input{src/algorithms/primitives/shamir.tex}
...
\input{src/algorithms/primitives/additivetoshamir.tex}

\input{src/algorithms/primitives/shamirtoadditive.tex}
...
\begin{itemize}
    ...
    \input{src/algorithms/primitives/feldman.tex}
...
\input{src/algorithms/primitives/pedersen.tex}

% iv. Transcript  [Alberto]
% □ Mention this is no longer just for fiat Shamir, but to glue protocols together.
% API differences from Merlin - no need for strobe.
...
\input{src/algorithms/primitives/transcript.tex}

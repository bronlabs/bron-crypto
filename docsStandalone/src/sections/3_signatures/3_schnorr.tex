...
% § Why schnorr and not EdDSA? [TODO:[Alberto]]
% § Differences between Schnorr and Eddsa (keygen, signing) [TODO:[Alberto]]
% § BIP340 for single party   [Hoang]
...
\input{src/algorithms/signatures/schnorr.tex}
...
\input{src/algorithms/signatures/bip340.tex}


\input{src/algorithms/signatures/eddsa.tex}

...
\begin{protocol}[H]
    ...
    \begin{algorithmic}[1]
        ...
        \end{alginfo} 
        \Players $t$ players out of the $n$ private-key share holders $\party{1}, \ldots, \party{n}$. At least one signature aggregator $\party{SA}$, who may or may not be in the cohort

...
This is essentially [interactive signing](../../../../signatures/threshold/tecdsa/lindell17/signing/interactive/README.md) from [Fast Secure Two-Party ECDSA Signing][Lin17] split into PreGen and Sign phase.

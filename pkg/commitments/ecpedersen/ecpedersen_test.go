...
func randomCk(tb testing.TB, curve curves.Curve, prng io.Reader) *ecpedersen_comm.CommittingKey {
	tb.Helper()
	...
	return ecpedersen_comm.NewCommittingKey(g, h)
}

func randomMessage(tb testing.TB, curve curves.Curve, prng io.Reader) ecpedersen_comm.Message {
	tb.Helper()

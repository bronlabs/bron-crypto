...
\inputFunctionality{commitments}{commitments.tex}
...
\begin{enumerate}
    ...
    \inputAlgorithm{commitments/hash}{hashcommitments.tex}
    ...
    \inputAlgorithm{commitments/pedersen}{pedersencommitments.tex}

// Package pedersen implements Pedersen commitments in two flavors:
//
...
//
// Both flavors expose the same Scheme/Committer/Verifier surface and an
...
// ring-Pedersen flavor they enforce the message bit-bound ℓ that anchors the
// strong-RSA reduction and the statistical-hiding range for the witness; in
// the prime-group flavor they verify membership in the scalar field.
//

...
func TestNewCommitment(t *testing.T) {
	...
	t.Run("nil input rejected", func(t *testing.T) {
		t.Parallel()
		c, err := hashcom.NewCommitment(nil)
		require.Error(t, err)
		require.Equal(t, hashcom.Commitment{}, c)
	})

	t.Run("empty input rejected", func(t *testing.T) {
		t.Parallel()
		c, err := hashcom.NewCommitment([]byte{})
		require.Error(t, err)
		require.Equal(t, hashcom.Commitment{}, c)
	})
	...
	t.Run("too short rejected", func(t *testing.T) {
		t.Parallel()
		c, err := hashcom.NewCommitment(bytes.Repeat([]byte{0xAB}, hashcom.DigestSize-1))
		require.Error(t, err)
		require.Equal(t, hashcom.Commitment{}, c)
	})
	...
	t.Run("exact length succeeds and copies contents", func(t *testing.T) {
		t.Parallel()
		in := bytes.Repeat([]byte{0xAB}, hashcom.DigestSize)
		c, err := hashcom.NewCommitment(in)
...
func TestNewWitness(t *testing.T) {
	...
	t.Run("nil input rejected", func(t *testing.T) {
		t.Parallel()
		w, err := hashcom.NewWitness(nil)
		require.Error(t, err)
		require.Equal(t, hashcom.Witness{}, w)
	})

	t.Run("empty input rejected", func(t *testing.T) {
		t.Parallel()
		w, err := hashcom.NewWitness([]byte{})
		require.Error(t, err)
		require.Equal(t, hashcom.Witness{}, w)
	})
	...
	t.Run("too short rejected", func(t *testing.T) {
		t.Parallel()
		w, err := hashcom.NewWitness(bytes.Repeat([]byte{0xCD}, hashcom.DigestSize-1))
		require.Error(t, err)
		require.Equal(t, hashcom.Witness{}, w)
	})
	...
	t.Run("exact length succeeds and copies contents", func(t *testing.T) {
		t.Parallel()
		in := bytes.Repeat([]byte{0xCD}, hashcom.DigestSize)
		w, err := hashcom.NewWitness(in)
		require.NoError(t, err)

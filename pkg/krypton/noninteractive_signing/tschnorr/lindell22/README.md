...
split into PreGen and Sign phase with pre-signature re-randomization as described in 2.5 of [The many faces of Schnorr][Shoup]
The PreGen consists of Round 1-3, where at last round each party stores $\left(k_i, k2_i, R_0, R_1, ..., R_{n-1}, R2_0, R2_1, ..., R_2{n-1}\right)$ as the pre-signature

...
func (s *EDDSASignature) MarshalBinary() ([]byte, error) {
...
func EDDSAVerify(curve *curves.Curve, hashFunction func() hash.Hash, signature *EDDSASignature, publicKey curves.Point, message []byte) error {

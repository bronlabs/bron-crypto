...
import (
	...
	"github.com/copperexchange/knox-primitives/pkg/knox/noninteractive_signing/tschnorr/frost"
)
...
func MapPreGenRound1OutputsToRound2Inputs(participants []*frost.PreGenParticipant, round1Outputs []*frost.Round1Broadcast) (round2Inputs []map[helper_types.IdentityHash]*frost.Round1Broadcast) {
	round2Inputs = make([]map[helper_types.IdentityHash]*frost.Round1Broadcast, len(participants))
	for i := range participants {
		round2Inputs[i] = make(map[helper_types.IdentityHash]*frost.Round1Broadcast)
...
func DoPreGenRound2(participants []*frost.PreGenParticipant, round2Inputs []map[helper_types.IdentityHash]*frost.Round1Broadcast) ([]*frost.PreSignatureBatch, [][]*frost.PrivateNoncePair, error) {
	var err error

...
2. Each $P_i$:
    ...
    2. opens commitments $(R_{com_i}', R_{com_i}'')$ revealing $(R_i', R_i'')$,
...
3. Each $P_i$:
    ...
    5. broadcasts $(pk_i, c_{key_i}', c_{key_i}'')$,
    6. proves in ZK to every $P_j$ (pairwise) that $pk_i$ was generated correctly (protocol $L_P$) and that $c_{key_i}'$ and $c_{key_i}''$ encrypt dlogs of $R_i'$ and $R_i''$ respectively (protocol $L_{PDL}$).
4. Each $P_i$:

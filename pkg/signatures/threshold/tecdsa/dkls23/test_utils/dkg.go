...
func MakeParticipants(t *testing.T, curve *curves.Curve, cohortConfig *integration.CohortConfig, identities []integration.IdentityKey, prngs []io.Reader, unmatchedSidParticipantIndex int) (participants []*dkg.Participant, err error) {

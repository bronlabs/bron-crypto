...
const (
	...
	// L is the ratio between scalars generated by the OTextension and the number
	// of BaseOT seeds. Set to 1 for DKLS23. All OTe/COTe inputs and outputs scale by L.
	L = 1
...
type (
	...
	// OTeReceiverOutput (v_x) ∈ [ξ][2][ω][κ]bits is the output of the receiver in the
	// OTe protocol ("DeltaOpt" in the diagram above)
	OTeReceiverOutput = [Zeta][OTeWidth][KappaBytes]byte

	// ------------------------- (Correlated) COTe -------------------------- //
	// COTeInputOpt (α) ∈ [ξ]curve.Scalar is the input of the sender in the COTe protocol (InputOpt)

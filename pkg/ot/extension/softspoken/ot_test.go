...
// 	"github.com/copperexchange/crypto-primitives-go/pkg/ot/base/simplest/simplest_test"
// )
...
// 		require.NoError(t, err)
// 		baseOtSenderOutput, baseOtReceiverOutput, err := simplest_test.RunSimplestOT(curve, Kappa, uniqueSessionId)
// 		require.NoError(t, err)
// 		for i := 0; i < Kappa; i++ {

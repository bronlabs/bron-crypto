...
The constructions in this section rely on three basic functions from this rfc:
...
As a result, the following functions are exported in this package:
1. `hash_to_scalar(msg, count) -> (u_0, ..., u_(count - 1))`, a stylistic alias for `hash_to_field`.

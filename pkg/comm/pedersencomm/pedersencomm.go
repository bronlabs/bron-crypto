...
func NewHomomorphicVerifier(sessionId []byte, curve curves.Curve) (*HomomorphicVerifier, error) {
	...
	return &HomomorphicVerifier{h, HomomorphicCommitmentScheme{}}, nil
}
...
func (v *HomomorphicVerifier) Verify(commitment *Commitment, opening *Opening) error {
	...
	curve := v.H.Curve()
	if curve != opening.message.ScalarField().Curve() {
...
func (*HomomorphicCommitmentScheme) CombineCommitments(x *Commitment, ys ...*Commitment) (*Commitment, error) {
...
func (*HomomorphicCommitmentScheme) ScaleCommitment(x *Commitment, n *saferith.Nat) (*Commitment, error) {
	if err := x.Validate(); err != nil {
...
func (*HomomorphicCommitmentScheme) ScaleOpening(x *Opening, n *saferith.Nat) (*Opening, error) {
	if err := x.Validate(); err != nil {

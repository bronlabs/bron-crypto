...
var _ comm.HomomorphicVerifier[Message, *Commitment, *Opening] = (*verifier)(nil)
...
func NewVerifier(sessionId []byte, publicKey curves.Point) (*verifier, error) { //nolint:revive // will be used by interface
	...
	hBlindBytes, err := hashing.HashChain(base.RandomOracleHashFunction, sessionId, nothingUpMySleeve)
	if err != nil {

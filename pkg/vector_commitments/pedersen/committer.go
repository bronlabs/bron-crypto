...
var _ vectorcommitments.VectorCommitter[Message, *VectorCommitment, *Opening] = (*VectorCommitter)(nil)
...
func (*VectorCommitter) OpenAtIndex(index uint, vector Vector, fullOpening *Opening) (commitments.Opening[Message], error) {
	panic("implement me")
}

...
var (
	...
	_ vectorcommitments.VectorCommitment = (*VectorCommitment)(nil)
...
type Vector = vectorcommitments.Vector[Message]
...
func (o *Opening) Message() vectorcommitments.Vector[Message] {
	return o.vector
}

...
func MapRound1OutputsToRound2Inputs(participants []*agreeonrandom.Participant, round1Outputs []*agreeonrandom.Round1Broadcast) (round2Inputs []*hashmap.HashMap[integration.IdentityKey, *agreeonrandom.Round1Broadcast]) {
	round2Inputs = make([]*hashmap.HashMap[integration.IdentityKey, *agreeonrandom.Round1Broadcast], len(participants))
	for i := range participants {
		round2Inputs[i] = hashmap.NewHashMap[integration.IdentityKey, *agreeonrandom.Round1Broadcast]()
...
func DoRound2(participants []*agreeonrandom.Participant, round2Inputs []*hashmap.HashMap[integration.IdentityKey, *agreeonrandom.Round1Broadcast]) (results [][]byte, err error) {

...
// const CounterModulus = 128

// type Counter = num.Uint

// var _ io.Reader = (*WrappedReader[ed255])(nil)

// type WrappedReader[SK signatures.PrivateKey[SK]] struct {
// 	// should be key for a **deterministic** signature scheme.
// 	deviceRandomnessDeterministicWrappingKey *signatures.PrivateKey
...
// 	}
// 	info, err := hashing.HashPrefixedLength(base.RandomOracleHashFunction, marshaledProfile, []byte(reflect.TypeOf(prng).String()))
// 	if err != nil {

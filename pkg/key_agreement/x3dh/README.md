...
The original protocol is outlined in [x3dh], however we this package implements the variant suitable for [art] (see Chapter 6.3 Analysis: Authenticated Protocol).  
...
and then $K$ is mapped to scalar using hash to field algorithm.

		...
		if input.E.Bit(i) == 0 {
			...
			case prover.inSecondThird(xPlusW1):
				...
				zetOne[i] = &ZetOne{
					J:        1,
					XPlusWj:  xPlusW1,
					RTimesRj: new(saferith.Nat).ModMul(prover.r, prover.state.r1[i], prover.sk.GetNModulus().Modulus()),
				}
			case prover.inSecondThird(xPlusW2):
				...
				zetOne[i] = &ZetOne{
					J:        2,
					XPlusWj:  xPlusW2,
					RTimesRj: new(saferith.Nat).ModMul(prover.r, prover.state.r2[i], prover.sk.GetNModulus().Modulus()),
				}
			default:

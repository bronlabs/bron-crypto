...
var _ compiler.NonInteractiveProtocol[sigma.Statement, sigma.Witness, sigma.State] = (*rf[
...
func (c *rf[X, W, A, S, Z]) NewProver(ctx *session.Context) (compiler.NIProver[W, S], error) {
	if ctx == nil {

...
func _[G curves.Point[G, B, S], B algebra.PrimeFieldElement[B], S algebra.PrimeFieldElement[S]](_ ecdsa.Curve[G, B, S]) {
	...
	var _ sigma.Witness = (*encelg.Witness[S])(nil)
	...
	var _ sigma.Protocol[*encelg.Statement[G, B, S], *encelg.Witness[S], *encelg.Commitment[G, B, S], *encelg.State[S], *encelg.Response[S]] = (*encelg.Protocol[G, B, S])(nil)
}

...
1. V:
    ...
    4. computes $com = commit(e, sid)$ and sends to $P$. Denote $e=e_0,...,e_{t-1}$
2. P:
    1. computes $l = \lfloor \frac{q}{3} \rfloor$,
    2. computes $x \leftarrow c - l$,
    3. chooses random $w^0_1, ..., w^{t-1}_1 \leftarrow \lbrace l, . . . , 2l \rbrace$ and computes $w^i_2 = w^i_1 − l$ for every $i = 0, . . . ,t-1$,

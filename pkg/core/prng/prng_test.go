...
import (
	...
	"github.com/copperexchange/knox-primitives/pkg/core/prng"
	rng_test_utils "github.com/copperexchange/knox-primitives/pkg/core/prng/test_utils"
)
...
func Test_AES256_ApiUsage(t *testing.T) {
	...
	prng, err := prng.NewAesPRNG(keySize, entropySource, entropyInput, nonce, personalization)

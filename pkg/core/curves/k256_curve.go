...
import (
	...
	secp256k1 "github.com/copperexchange/crypto-primitives-go/pkg/core/curves/native/k256"
	"github.com/copperexchange/crypto-primitives-go/pkg/core/curves/native/k256/fp"
	"github.com/copperexchange/crypto-primitives-go/pkg/core/curves/native/k256/fq"
)
...
func (s *ScalarK256) Hash(inputs ...[]byte) Scalar {
...
func (s *ScalarK256) CurveName() string {
	return new(PointK256).Identity().CurveName()
}
...
func (p *PointK256) Hash(inputs ...[]byte) Point {
	value, err := secp256k1.K256PointNew().Hash(bytes.Join(inputs, nil), native.EllipticPointHasherSha256())

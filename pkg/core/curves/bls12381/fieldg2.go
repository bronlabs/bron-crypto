...
func (FieldProfileG2) Order() *big.Int {
	return new(big.Int).Mul(p, p)
}

func (FieldProfileG2) Characteristic() *big.Int {
	return p
}

func (FieldProfileG2) ExtensionDegree() *big.Int {
	return big.NewInt(2)
}
...
func (e FieldElementG2) Modulus() *big.Int {
...
func (FieldElementG2) New(value int) curves.FieldElement {
	return nil
}
...
func (e FieldElementG2) SetBigInt(value *big.Int) (curves.FieldElement, error) {
	return e.SetBytes(value.Bytes())
}

func (FieldElementG2) BigInt() *big.Int {
	return nil
}

...
func (FieldProfileG1) Order() *big.Int {
	return p
}

func (FieldProfileG1) Characteristic() *big.Int {
	return p
}

func (FieldProfileG1) ExtensionDegree() *big.Int {
	return big.NewInt(1)
}
...
func (FieldElementG1) Modulus() *big.Int {
	return p
}
...
func (e FieldElementG1) New(value int) curves.FieldElement {
	return &FieldElementG1{
...
func (e FieldElementG1) SetBigInt(value *big.Int) (curves.FieldElement, error) {
	return e.SetBytes(value.Bytes())
}

func (e FieldElementG1) BigInt() *big.Int {
	return e.v.BigInt()
}

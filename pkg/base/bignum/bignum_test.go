...
//	xInt, err := crand.Int(crand.Reader, new(big.Int).Lsh(new(big.Int).SetUint64(1), 4096))
//	require.NoError(b, err)
//
//	xNat := new(saferith.Nat).SetBig(xInt, 4096)
//	xNum := new(BigNum).SetBytes(xNat.Bytes())
//
//	yInt, err := crand.Prime(crand.Reader, 4096)
//	require.NoError(b, err)
//
//	yNat := new(saferith.Nat).SetBig(yInt, 4096)
//	yNum := new(BigNum).SetBytes(yNat.Bytes())
//
//	b.ResetTimer()
//	b.Run("saferith (Add)", func(b *testing.B) {
//		for i := 0; i < b.N; i++ {
//			xNat = xNat.Add(xNat, yNat, 4096)
//		}
//	})
//
//	b.Run("BigNum (Add)", func(b *testing.B) {
//		for i := 0; i < b.N; i++ {
//			xNum = xNum.Add(xNum, yNum, 4096)
//		}
//	})
//	b.Run("saferith (Mul)", func(b *testing.B) {
//		for i := 0; i < b.N; i++ {
//			xNat = xNat.Mul(xNat, yNat, 4096)
//		}
//	})
//
//	b.Run("BigNum (Mul)", func(b *testing.B) {
//		for i := 0; i < b.N; i++ {
//			xNum = xNum.Mul(xNum, yNum, 4096)
//		}
//	})
//}

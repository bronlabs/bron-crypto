...
type ResidueNumberSystem struct {
	traits.VariadicDirectProductRing[*Zn, *Uint, *ResidueNumber, ResidueNumber]
	m                     *saferith.Modulus
...
func (r *ResidueNumberSystem) Operator() algebra.BinaryOperator[*ResidueNumber] {
	return algebra.Add[*ResidueNumber]
}

func (r *ResidueNumberSystem) OtherOperator() algebra.BinaryOperator[*ResidueNumber] {
	return algebra.Mul[*ResidueNumber]
}
...
type ResidueNumber struct {
	traits.VariadicDirectProductRingElement[*Uint, *ResidueNumber, ResidueNumber]
	ms []*saferith.Modulus
	m  *saferith.Modulus
	es []*saferith.Nat
}
...
func (n *ResidueNumber) Set(components ...*Uint) error {
	if err := n.VariadicDirectProductRingElement.Set(components...); err != nil {
...
func (n *ResidueNumber) SetAt(i int, c *Uint) error {
	if err := n.VariadicDirectProductRingElement.SetAt(i, c); err != nil {

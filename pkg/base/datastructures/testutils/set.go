...
func Set[S ds.Set[E], E any](t *testing.T, s S) {
	t.Helper()
	...
	t.Run("IsEmpty", func(t *testing.T) {
		...
		if s.Size() == 0 {
			require.True(t, isEmpaty)
		} else{
			require.False(t, isEmpaty)
		}
	})
}

func SetOp[S ds.Set[E], E any](t *testing.T, s S, a S, isMember IsElement[S, E]) {

}
	// func SetElement[S ds.Set[E], E any](t *testing.T, s S, e E) {
// 	t.Helper()
// 	require.NotNil(t, s)
// 	require.NotNil(t, e)
...
// func IsSet[S ds.Set[E], E any](t *testing.T, s S) {
// 	t.Helper()
// 	Set(t, s, SetElement)
// }

...
func (n *Nat) AddCap(other *Nat, cap int) *Nat {
	if other == nil {
		panic("argument is nil")
	}
	out := new(saferith.Nat).Add(&n.v, &other.v, cap)
	return &Nat{v: *out}
}

func (n *Nat) Mul(other *Nat) *Nat {
	return n.MulCap(other, -1)
}

func (n *Nat) MulCap(other *Nat, cap int) *Nat {
	if other == nil {
		panic("argument is nil")
	}
	out := new(saferith.Nat).Mul(&n.v, &other.v, cap)
	return &Nat{v: *out}
}
...
func (n *Nat) TrySub(other *Nat) (*Nat, error) {
	return n.TrySubCap(other, -1)
}

func (n *Nat) TrySubCap(other *Nat, cap int) (*Nat, error) {
	if other == nil {
		panic("argument is nil")
	}
	...
	out := new(saferith.Nat).Sub(&n.v, &other.v, cap)
	return &Nat{v: *out}, nil
}
...
func (n *Nat) TryDiv(other *NatPlus) (*Nat, error) {
	return n.TryDivCap(other, -1)
}

func (n *Nat) TryDivCap(other *NatPlus, cap int) (*Nat, error) {
	if other == nil {
		panic("argument is nil")
	}
	quot, rem, err := n.EuclideanDivCap(other, cap)
	if err != nil {
...
func (n *Nat) EuclideanDiv(other *NatPlus) (quot, rem *Nat, err error) {
	return n.EuclideanDivCap(other, -1)
}

func (n *Nat) EuclideanDivCap(other *NatPlus, cap int) (quot, rem *Nat, err error) {
	if other == nil {
		panic("argument is nil")
	}
	safeModulus := saferith.ModulusFromNat(&other.v)
	q := new(saferith.Nat).Div(&n.v, safeModulus, cap)
	r := new(saferith.Nat).Mod(&n.v, safeModulus)

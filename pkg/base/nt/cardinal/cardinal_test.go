...
func TestUnknown_Properties(t *testing.T) {
	...
	t.Run("uint64 returns zero", func(t *testing.T) {
		require.Equal(t, uint64(0), u.Uint64())
	})

	t.Run("big returns nil", func(t *testing.T) {
		require.Nil(t, u.Big())
	})

	t.Run("bytes returns nil", func(t *testing.T) {
		require.Nil(t, u.Bytes())
	})

	t.Run("bit length is zero", func(t *testing.T) {
		require.Equal(t, 0, u.BitLen())
	})
}
...
func TestInfinite_Properties(t *testing.T) {
	...
	t.Run("IsInfinite helper", func(t *testing.T) {
		require.True(t, cardinal.IsInfinite(inf))
		require.False(t, cardinal.IsInfinite(cardinal.New(42)))
		require.False(t, cardinal.IsInfinite(cardinal.Unknown{}))
	})
	...
	t.Run("uint64 returns max", func(t *testing.T) {
		require.Equal(t, uint64(math.MaxUint64), inf.Uint64())
	})

	t.Run("big returns nil", func(t *testing.T) {
		require.Nil(t, inf.Big())
	})

	t.Run("bytes returns nil", func(t *testing.T) {
		require.Nil(t, inf.Bytes())
	})

	t.Run("bit length is zero", func(t *testing.T) {
		require.Equal(t, 0, inf.BitLen())
	})

	t.Run("is not probably prime", func(t *testing.T) {
		require.False(t, inf.IsProbablyPrime())
	})
}
...
func TestInfinite_Arithmetic(t *testing.T) {
	...
	t.Run("add returns infinite", func(t *testing.T) {
		...
		require.True(t, cardinal.IsInfinite(result))
	})
...
func TestInfinite_Clone(t *testing.T) {
	...
	inf := cardinal.Infinite{}
	cloned := inf.Clone()
	require.True(t, cardinal.IsInfinite(cloned))
}

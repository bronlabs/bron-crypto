...
type paillierGroupUnknownDTO struct {
	UZMod *DenseUZMod[*modular.SimpleModulus] `cbor:"uzmod"`
	N     *num.NatPlus                        `cbor:"n"`
}

type paillierGroupKnownDTO struct {
	UZMod *DenseUZMod[*modular.OddPrimeSquareFactors] `cbor:"uzmod"`
	N     *num.NatPlus                                `cbor:"n"`
}
...
type rsaGroupDTO struct {
	UZMod *DenseUZMod[*modular.OddPrimeFactors] `cbor:"uzmod"`
}

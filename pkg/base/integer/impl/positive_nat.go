...
// var _ integer.NPlus[any, any] = (*NPlus[any, any])(nil)
...
func (n *NPlus[NS, N]) ChainElement() algebra.ChainElement[NS, N]

func (n *NPlus[NS, N]) Cardinality() *saferith.Modulus

func (n *NPlus[NS, N]) Element() N

func (n *NPlus[NS, N]) Contains(x N) bool

func (n *NPlus[NS, N]) Addition() algebra.Addition[N]

func (n *NPlus[NS, N]) Test() {
	n.Add
}

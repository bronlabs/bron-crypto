...
func MapO2I[
	ProtocolT types.Protocol, PartyT types.Participant[ProtocolT], BcastT network.Message[ProtocolT], UnicastT network.Message[ProtocolT],
](
	participants []PartyT,
...
func MapBroadcastO2I[
	ProtocolT types.Protocol, PartyT types.Participant[ProtocolT], BcastT network.Message[ProtocolT],
](
	participants []PartyT,
	broadcastOutputs []BcastT,
) (
...
func MapUnicastO2I[
	ProtocolT types.Protocol, PartyT types.Participant[ProtocolT], UnicastT network.Message[ProtocolT],
](
	participants []PartyT,

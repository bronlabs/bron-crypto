...
// type PublicKey[PK types.SchemeElement[Type]] types.PublicKey[PK, Type]
// type PrivateKey[SK types.SchemeElement[Type], PK PublicKey[PK]] types.PrivateKey[SK, PK, Type]

...
func (m *RegularModule[R, E, W, WT]) IsDomain() bool {
	return m.Ring.IsDomain()
}
...
func (m *RegularModule[R, E, W, WT]) FromBytes(b []byte) (W, error) {
	...
	if err := W(&out).set(el); err != nil {
		return nil, errs.Wrap(err).WithMessage("failed to set element from bytes")
	}
	return W(&out), nil
}
...
func (m *RegularModule[R, E, W, WT]) OpIdentity() W {
	...
	if err := W(&out).set(m.Ring.OpIdentity()); err != nil {
		panic(errs.Wrap(err).WithMessage("failed to set op identity"))
	}
	return W(&out)
}
...
func (m *RegularModule[R, E, W, WT]) Zero() W {
	...
	if err := W(&out).set(m.Ring.Zero()); err != nil {
		panic(errs.Wrap(err).WithMessage("failed to set zero element"))
	}
	return W(&out)
}
...
func (m *RegularModuleElement[E, W, WT]) set(v E) error {
	if utils.IsNil(v) {
		return ErrInvalidArgument.WithMessage("value is nil")
	}
	m.v = v
	return nil
}
...
func (m *RegularModuleElement[E, W, WT]) Op(other W) W {
	if other == nil {
		panic(ErrInvalidArgument.WithMessage("other element is nil"))
	}
	var out WT
	if err := W(&out).set(m.v.Op(other.Value())); err != nil {
		panic(errs.Wrap(err).WithMessage("failed to apply operation"))
	}
	return W(&out)
}
...
func (m *RegularModuleElement[E, W, WT]) Add(other W) W {
	...
	if err := W(&out).set(m.v.Add(other.Value())); err != nil {
		panic(errs.Wrap(err).WithMessage("failed to add element"))
	}
	return W(&out)
}
...
func (m *RegularModuleElement[E, W, WT]) TrySub(other W) (W, error) {
	if other == nil {
		return nil, ErrInvalidArgument.WithMessage("other element is nil")
	}
	var out WT
...
func (m *RegularModuleElement[E, W, WT]) Sub(other W) W {
	...
	if err := W(&out).set(m.v.Sub(other.Value())); err != nil {
		panic(errs.Wrap(err).WithMessage("failed to subtract element"))
	}
	return W(&out)
}
...
func (m *RegularModuleElement[E, W, WT]) Double() W {
	...
	if err := W(&out).set(m.v.Double()); err != nil {
		panic(errs.Wrap(err).WithMessage("failed to double element"))
	}
	return W(&out)
}
...
func (m *RegularModuleElement[E, W, WT]) TryNeg() (W, error) {
	...
	v, err := m.v.TryNeg()
	if err != nil {
		return nil, errs.Wrap(err).WithMessage("failed to negate element")
	}
	if err := W(&out).set(v); err != nil {
		return nil, errs.Wrap(err).WithMessage("failed to set negated element")
	}
	return W(&out), nil
}
...
func (m *RegularModuleElement[E, W, WT]) Neg() W {
	...
	if err := W(&out).set(m.v.Neg()); err != nil {
		panic(errs.Wrap(err).WithMessage("failed to negate element"))
	}
	return W(&out)
}
...
func (m *RegularAlgebraElement[E, W, WT]) TryInv() (W, error) {
	vv, err := m.v.TryInv()
	if err != nil {
		return nil, errs.Wrap(err).WithMessage("failed to invert RegularAlgebraElement")
	}
	var out WT
	if err := W(&out).set(vv); err != nil {
		return nil, errs.Wrap(err).WithMessage("failed to set inverted RegularAlgebraElement")
	}
	return W(&out), nil
}
...
func (m *RegularAlgebraElement[E, W, WT]) OpInv() W {
	...
	if err := W(&out).set(m.v.OpInv()); err != nil {
		panic(errs.Wrap(err).WithMessage("failed to invert RegularAlgebraElement"))
	}
	return W(&out)
}
...
func (m *RegularAlgebraElement[E, W, WT]) TryDiv(other W) (W, error) {
	...
	if err != nil {
		return nil, errs.Wrap(err).WithMessage("failed to divide RegularAlgebraElement")
	}
	var out WT
	if err := W(&out).set(vv); err != nil {
		return nil, errs.Wrap(err).WithMessage("failed to set divided RegularAlgebraElement")
	}
	return W(&out), nil
}
...
func (m *RegularAlgebraElement[E, W, WT]) Mul(other W) W {
	...
	if err := W(&out).set(m.v.Mul(other.Value())); err != nil {
		panic(errs.Wrap(err).WithMessage("failed to multiply RegularAlgebraElement"))
	}
	return W(&out)
}
...
func (m *RegularAlgebraElement[E, W, WT]) Square() W {
	...
	if err := W(&out).set(m.v.Square()); err != nil {
		panic(errs.Wrap(err).WithMessage("failed to square RegularAlgebraElement"))
	}
	return W(&out)
}
...
func (m *FiniteRegularStructure[R, E, W, WT]) Random(prng io.Reader) (W, error) {
	...
	if err != nil {
		return nil, errs.Wrap(err).WithMessage("could not sample random element")
	}
	var out WT
	if err := W(&out).set(v); err != nil {
		return nil, errs.Wrap(err).WithMessage("could not set random element")
	}
	return W(&out), nil
}
...
func (m *FiniteRegularStructure[R, E, W, WT]) Hash(input []byte) (W, error) {
	...
	var out WT
	if err := W(&out).set(v); err != nil {
		return nil, errs.Wrap(err).WithMessage("could not set hashed element")
	}
	return W(&out), nil
}

...
func FixedCapacityOperator[E FixedCapacityOperand[E]](a E, b E, capacity int) E {
...
func FixedCapacityDualOperator[E FixedCapacityDualOperand[E]](a E, b E, capacity int) E {
...
func FixedCapacityAddition[E FixedCapacitySummand[E]](a E, b E, capacity int) E {
...
func MaybeFixedCapacityAddition[E MaybeFixedCapacitySummand[E]](a E, b E, capacity int) (E, error) {
...
func FixedCapacitySubtraction[E FixedCapacityMinuend[E]](a E, b E, capacity int) E {
...
func MaybeFixedCapacitySubtraction[E MaybeFixedCapacityMinuend[E]](a E, b E, capacity int) (E, error) {
...
func FixedCapacityMultiplication[E FixedCapacityMultiplicand[E]](a E, b E, capacity int) E {
...
func MaybeFixedCapacityMultiplication[E MaybeFixedCapacityMultiplicand[E]](a E, b E, capacity int) (E, error) {
...
func FixedCapacityDivision[E FixedCapacityDividend[E]](a E, b E, capacity int) E {
...
func MaybeFixedCapacityDivision[E MaybeFixedCapacityDividend[E]](a E, b E, capacity int) (E, error) {
...
func FixedCapacityExponentiate[A FixedCapacityExponentiationBase[A, E], E Element[E]](base A, exponent E, capacity int) A {
	return base.ExpCap(exponent, capacity)
}
...
func MaybeFixedCapacityExponentiate[A MaybeFixedCapacityExponentiationBase[A, E], E Element[E]](base A, exponent E, capacity int) (A, error) {
	return base.TryExpCap(exponent, capacity)
}

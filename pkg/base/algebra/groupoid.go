...
type Groupoid[G Structure, E Element] interface {
	...
	StructuredSet[G, E]
	Operate(under Operator, x GroupoidElement[G, E], ys ...GroupoidElement[G, E]) (E, error)
}
...
type GroupoidElement[G Structure, E Element] interface {
	...
	Order(under Operator) (*saferith.Nat, error)
	Operate(with BinaryOperator[E], rhs GroupoidElement[G, E]) (E, error)
	Apply(under Operator, x GroupoidElement[G, E], n *saferith.Nat) (E, error)

	CanGenerateAllElements(with BinaryOperator[E]) bool
}
...
type AdditiveGroupoidElement[G Structure, E Element] interface {
	GroupoidElement[G, E]
	// AdditivelyCommutesWith(x AdditiveGroupoidElement[G, E])
...
type MultiplicativeGroupoidElement[G Structure, E Element] interface {
	GroupoidElement[G, E]
	// MultiplicativelyCommutesWith(x MultiplicativeGroupoidElement[G, E])

...
type GroupoidElement[G Structure, E Element] interface {
	...
	// Op(operator BinaryOperator[E], rhs GroupoidElement[G, E]) (E, error)
	// IsIdempotentUnder(operator BinaryOperator[E])
	// CommutesWith(under BinaryOperator[E], x GroupoidElement[G, E]) (bool, error)
...
type MultiplicativeGroupoid[G Structure, E Element] interface {
	...
	Exp(base, power E) E
	// Simultaneous exponentiation. base[0]^exponents[0] * base[1]^exponents[1] * ...

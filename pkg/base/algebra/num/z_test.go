...
func TestIntegers_UtilityMethods(t *testing.T) {
	...
	t.Run("IsInRange", func(t *testing.T) {
		...
		// IsInRange checks symmetric range: for modulus 10, range is actually [-5, 5]
		// For even modulus, the range includes both -m/2 and m/2
		// Values in symmetric range [-5, 5]
		require.True(t, num.Z().Zero().IsInRange(modulus))
		require.True(t, num.Z().FromInt64(5).IsInRange(modulus))
		require.True(t, num.Z().FromInt64(-5).IsInRange(modulus))

		// Values out of symmetric range
		require.False(t, num.Z().FromInt64(6).IsInRange(modulus))
		require.False(t, num.Z().FromInt64(-6).IsInRange(modulus))
...
func TestIntegers_Comparison(t *testing.T) {
	...
	t.Run("Compare", func(t *testing.T) {
		...
		testCases := []struct {
			...
			{num.Z().Zero(), num.Z().Zero(), base.Equal},
			{num.Z().One(), num.Z().One(), base.Equal},
			{num.Z().Zero(), num.Z().One(), base.LessThan},
			{num.Z().One(), num.Z().Zero(), base.GreaterThan},
			{num.Z().FromInt64(42), num.Z().FromInt64(42), base.Equal},
			{num.Z().FromInt64(41), num.Z().FromInt64(42), base.LessThan},
			{num.Z().FromInt64(43), num.Z().FromInt64(42), base.GreaterThan},
			{num.Z().FromInt64(-1), num.Z().FromInt64(1), base.LessThan},
			{num.Z().FromInt64(1), num.Z().FromInt64(-1), base.GreaterThan},
			{num.Z().FromInt64(-42), num.Z().FromInt64(-41), base.LessThan},
			{num.Z().FromInt64(-41), num.Z().FromInt64(-42), base.GreaterThan},
		}
...
func TestIntegers_Bytes(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		require.True(t, bytes.Equal(tc.expected, result))

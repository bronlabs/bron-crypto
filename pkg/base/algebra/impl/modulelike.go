...
type ZLikeSemiModule[E, S any] SemiModule[E, S]

type ZLikeSemiModuleElement[E, S any] SemiModuleElement[E, S]
...
type FiniteModuleElement[ME, S any] interface {
	ModuleElement[ME, S]
	FiniteGroupElement[ME]
}
...
type FiniteAlgebra[AE, S any] interface {
	Algebra[AE, S]
	FiniteModule[AE, S]
	FiniteRing[AE]
}

type FiniteAlgebraElement[AE, S any] interface {
	AlgebraElement[AE, S]
	FiniteModuleElement[AE, S]
	FiniteRingElement[AE]
}

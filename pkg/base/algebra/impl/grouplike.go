...
type FiniteGroupElement[GE any] interface {
	GroupElement[GE]
}

// ************** Extra Monoids

type AbelianMonoid[E, S any] ZLikeSemiModule[E, S]

type AbelianMonoidElement[E, S any] SemiModuleElement[E, S]

type FiniteAbelianMonoid[E, S any] interface {
	AbelianMonoid[E, S]
	FiniteStructure[E]
}

type FiniteAbelianMonoidElement[E, S any] AbelianMonoidElement[E, S]
...
type FiniteAbelianGroup[E, S any] interface {
	AbelianGroup[E, S]
	FiniteAbelianMonoid[E, S]
	FiniteGroup[E]
}

type FiniteAbelianGroupElement[E, S any] interface {
	AbelianGroupElement[E, S]
	FiniteAbelianMonoidElement[E, S]
	FiniteGroupElement[E]
}

...
// EllipticCurve specifies an Elliptic Curve in the context where scalar multiplication makes sense.
...
type EllipticCurve[EllipticCurveType, BaseFieldType, ScalarRingType algebra.Structure,
	PointType, BaseFieldElementType, ScalarType algebra.Element] interface {
...
type GeneralEllipticCurvePoint[EllipticCurveType, BaseFieldType algebra.Structure,
	PointType, BaseFieldElementType algebra.Element] interface {
...
type Curve interface {
	...
	EllipticCurve[Curve, BaseField, ScalarField, Point, BaseFieldElement, Scalar]

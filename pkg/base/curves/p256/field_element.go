...
func (e *BaseFieldElement) MulAdd(y algebra.SemiRingElement[curves.BaseField, curves.BaseFieldElement], z algebra.SemiRingElement[curves.BaseField, curves.BaseFieldElement]) curves.BaseFieldElement {
...
func (e *BaseFieldElement) Exp(exponent *saferith.Nat) curves.BaseFieldElement {
	ex, ok := e.Structure().Element().SetNat(exponent).Unwrap().(*BaseFieldElement)
	if !ok {
		panic("not a p256 Fp element")
	}
	return &BaseFieldElement{
...
func (e *BaseFieldElement) Cmp(rhs algebra.OrderTheoreticLatticeElement[curves.BaseField, curves.BaseFieldElement]) algebra.Ordering {
	...
	return algebra.Ordering(e.V.Cmp(rhsP256.V))
}

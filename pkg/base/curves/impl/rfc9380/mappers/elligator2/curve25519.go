...
func mapToCurveElligator2Curve25519[FP fieldsImpl.PrimeFieldElementPtr[FP, F], F any](xnOut, xdOut, ynOut, ydOut, u *F) {
...
func sgn0[FP fieldsImpl.PrimeFieldElement[FP]](in FP) ct.Bool {
	inBytes := in.Bytes()

...
func (*ErisPoint) ToCompressed() [FieldBytes]byte {
...
func (*ErisPoint) FromCompressed(input *[FieldBytes]byte) (*ErisPoint, error) {
	panic("not implemented")
	//var xFp, yFp Fp
...
func (*ErisPoint) ToUncompressed() [WideFieldBytes]byte {
	panic("not implemented")
...
func (*ErisPoint) FromUncompressed(input *[WideFieldBytes]byte) (*curves.Point, error) {
	panic("not implemented")
	//var xFp, yFp Fp

...
var (
	...
	plutoScalarFieldInstance ScalarField[PlutoCurve]

	tritonScalarFieldInitOnce sync.Once
	tritonScalarFieldInstance ScalarField[TritonCurve]
)

var _ curves.ScalarField = (*ScalarField[PlutoCurve])(nil)
var _ curves.ScalarField = (*ScalarField[TritonCurve])(nil)
...
func bls12381G1ScalarFieldInit() {
	plutoScalarFieldInstance = ScalarField[G1]{}
}

func bls12381G2ScalarFieldInit() {
	tritonScalarFieldInstance = ScalarField[G2]{}
}

func NewScalarFieldG1() *ScalarField[G1] {
	plutoScalarFieldInitOnce.Do(bls12381G1ScalarFieldInit)
	return &plutoScalarFieldInstance
}

func NewScalarFieldG2() *ScalarField[G2] {
	tritonScalarFieldInitOnce.Do(bls12381G2ScalarFieldInit)

...
var (
	_ curves.BaseField = (*PlutoBaseField)(nil)

	plutoBaseFieldInitOnce sync.Once
	plutoFieldInstance     PlutoBaseField
)
...
func (*PlutoBaseField) Cardinality() *saferith.Nat {
	//TODO implement me
	panic("implement me")
}
...
func (*PlutoBaseField) Iterator() ds.Iterator[curves.BaseFieldElement] {
	//TODO implement me
	panic("implement me")
}

...
var (
	plutoScalarFieldInitOnce sync.Once
	plutoScalarFieldInstance ScalarField[Pluto]

	tritonScalarFieldInitOnce sync.Once
	tritonScalarFieldInstance ScalarField[Triton]
)

var _ curves.ScalarField = (*ScalarField[Pluto])(nil)
var _ curves.ScalarField = (*ScalarField[Triton])(nil)

type ScalarField[S SourceSubGroups] struct {
	_ ds.Incomparable
}

func plutoScalarFieldInit() {
	plutoScalarFieldInstance = ScalarField[Pluto]{}
}

func tritonScalarFieldInit() {
	tritonScalarFieldInstance = ScalarField[Triton]{}
}

func NewPlutoScalarField() *ScalarField[Pluto] {
	plutoScalarFieldInitOnce.Do(plutoScalarFieldInit)
	return &plutoScalarFieldInstance
}

func NewTritonScalarField() *ScalarField[Triton] {
	tritonScalarFieldInitOnce.Do(tritonScalarFieldInit)
	return &tritonScalarFieldInstance
}
...
func (*ScalarField[_]) Hash(x []byte) (curves.Scalar, error) {

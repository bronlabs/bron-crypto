...
func (gi *AdditiveGroupInvariants[G, GE]) IsIdentity(t *testing.T, group G, element GE) {
	t.Helper()
...
func (gi *AdditiveGroupInvariants[G, GE]) Add(t *testing.T, group G, el1 GE, el2 GE) {
	t.Helper()

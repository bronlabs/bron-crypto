...
func (pa PointAdapter) Wrap(x fu.Underlyer) curves.Point {
	...
	binary.LittleEndian.PutUint64(buffer[:8], uint64(x))
...
func (pa PointAdapter) Unwrap(p curves.Point) fu.Underlyer {
...
func (sa *ScalarAdapter) Unwrap(s curves.Scalar) fu.Underlyer {
...
func (ba *BaseFieldElementAdapter) Unwrap(f curves.BaseFieldElement) fu.Underlyer {

...
func (*BaseFieldG1) Arithmetic() integer.Arithmetic[curves.BaseFieldElement] {
	panic("not implemented")
}
func (*BaseFieldG1) Factorise() []curves.BaseFieldElement {
	panic("not implemented")
}
func (*BaseFieldG1) RandomPrime(prng io.Reader) curves.BaseFieldElement {
	panic("not implemented")
}
...
func (*BaseFieldG1) GetOperator(op algebra.Operator) (algebra.BinaryOperator[curves.BaseFieldElement], bool) {
	//TODO implement me
	panic("implement me")
}
...
func (*BaseFieldG1) Iter() <-chan curves.BaseFieldElement {
	//TODO implement me
	panic("implement me")
}
...
func (*BaseFieldG1) IsDefinedUnder(operator algebra.Operator) bool {
	//TODO implement me
	panic("implement me")
}

func (*BaseFieldG1) Operate(operator algebra.Operator, x algebra.GroupoidElement[curves.BaseField, curves.BaseFieldElement], ys ...algebra.GroupoidElement[curves.BaseField, curves.BaseFieldElement]) (curves.BaseFieldElement, error) {
	//TODO implement me
	panic("implement me")
}
...
func (*BaseFieldG1) Exp(b algebra.MultiplicativeGroupoidElement[curves.BaseField, curves.BaseFieldElement], exponent *saferith.Nat) curves.BaseFieldElement {
	//TODO implement me
	panic("implement me")
}
...
func (*BaseFieldG1) Identity(under algebra.Operator) (curves.BaseFieldElement, error) {
	//TODO implement me
	panic("implement me")
}
...
func (*BaseFieldG1) IsDecomposable(coprimeIdealNorms ...integer.Uint[curves.BaseField, curves.BaseFieldElement]) (bool, error) {
	//TODO implement me
	panic("implement me")
}

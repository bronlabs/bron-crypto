...
var (
	...
	g2SqrtRatioC3 = [...]uint64{0xb26aa00001c718e3, 0xd7ced6b1d76382ea, 0x3162c338362113cf, 0x966bf91ed3e71b74, 0xb292e85a87091a04, 0x11d68619c86185c7, 0xef53149330978ef0, 0x050a62cfd16ddca6, 0x466e59e49349e8bd, 0x9e2dc90e50e7046b, 0x74bd278eaa22f25e, 0x002a437a4b8c35fc}
...
func clearCofactorBls12381G2(out, in *G2Point) {
	...
	// 1.  t1 = c1 * P
	pointsImpl.ScalarMulLimbs[*Fp2](&t1, in, []uint64{X})
	t1.Neg(&t1)
	...
	// 7.  t2 = c1 * t2
	pointsImpl.ScalarMulLimbs[*Fp2](&t2, &t2, []uint64{X})
	t2.Neg(&t2)

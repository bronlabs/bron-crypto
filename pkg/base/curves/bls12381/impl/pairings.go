...
//}
//
//func affinize[FP fieldsImpl.FiniteFieldPtrConstraint[FP, F], C pointsImpl.ShortWeierstrassCurveParams[FP], H h2c.HasherParams, M h2c.PointMapper[FP], F any](out, in *pointsImpl.ShortWeierstrassPointImpl[FP, C, H, M, F]) {
//	var x, y, zInv F
//	FP(&zInv).Inv(&in.Z)
//	FP(&x).Mul(&in.X, &zInv)
//	FP(&y).Mul(&in.Y, &zInv)

...
var (
	_ curves.PairingFriendlyCurve[*PointG1, *BaseFieldElementG1, *Scalar, *PointG2, *BaseFieldElementG2] = (*CurveG1)(nil)
...
func (c *CurveG1) OtherCurve() algebra.TorsionFreeEllipticCurve[*PointG2, *BaseFieldElementG2, *Scalar] {
	return NewG2Curve()
}

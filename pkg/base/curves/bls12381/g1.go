...
func (*G1) GetOperator(name algebra.Operator) (algebra.BinaryOperator[curves.Point], bool) {
	//TODO implement me
	panic("implement me")
}
...
func (*G1) IsDefinedUnder(operator algebra.Operator) bool {
	//TODO implement me
	panic("implement me")
}

func (*G1) Operate(operator algebra.Operator, x algebra.GroupoidElement[curves.Curve, curves.Point], ys ...algebra.GroupoidElement[curves.Curve, curves.Point]) (curves.Point, error) {
	//TODO implement me
	panic("implement me")
}
...
func (*G1) DLog(b, x algebra.CyclicGroupElement[curves.Curve, curves.Point], under algebra.Operator) (*saferith.Nat, error) {
	//TODO implement me
	panic("implement me")
}
...
func (*G1) Identity(under algebra.Operator) (curves.Point, error) {
	panic("implement me")
}

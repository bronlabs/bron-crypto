...
func (s *Scalar) MulAdd(p algebra.SemiRingElement[curves.ScalarField, curves.Scalar], q algebra.SemiRingElement[curves.ScalarField, curves.Scalar]) curves.Scalar {

...
//
//var (
//	fieldOrder = saferith.ModulusFromNat(new(saferith.Nat).SetBig(k256.NewElliptic().P, k256.NewElliptic().P.BitLen()))
//	groupOrder = saferith.ModulusFromNat(new(saferith.Nat).SetBig(k256.NewElliptic().N, k256.NewElliptic().N.BitLen()))
//)
//
...
//			for i := range scalars {
//				s, err := new(k256.ScalarK256).Random(crand.Reader)
//				require.NoError(b, err)
...
//	return &BenchPoint{
//		x: new(saferith.Nat).SetBig(k256.NewElliptic().Gx, fieldOrder.BitLen()),
//		y: new(saferith.Nat).SetBig(k256.NewElliptic().Gy, fieldOrder.BitLen()),
//	}
//}
//
...
//	return k256.NewElliptic().IsOnCurve(p.x.Big(), p.y.Big())
//}
//
//func (p *BenchPoint) Double() curves.Point {
//	x, y := k256.NewElliptic().Double(p.x.Big(), p.y.Big())
//	return &BenchPoint{
...
//	r := rhs.(*BenchPoint)
//	x, y := k256.NewElliptic().Add(p.x.Big(), p.y.Big(), r.x.Big(), r.y.Big())
//	return &BenchPoint{
...
//	k := rhs.Bytes()
//	x, y := k256.NewElliptic().ScalarMult(p.x.Big(), p.y.Big(), k)
//	return &BenchPoint{
//		x: new(saferith.Nat).SetBig(x, fieldOrder.BitLen()),
//		y: new(saferith.Nat).SetBig(y, fieldOrder.BitLen()),
//	}

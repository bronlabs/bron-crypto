...
func (c *CurveTrait[FP, P, W, WT]) Generator() W {
	var gen WT
...
func (c *CurveTrait[FP, P, W, WT]) TorsionFreeSubGroupGenerator() W {
	return c.Generator()
}
...
func (p *PointTrait[FP, P, T, W, WT]) IsDesignatedGenerator() bool {
	var generator WT

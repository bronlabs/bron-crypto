...
//   out2: [0x0 ~> 0x1]
func fiatFpAddcarryxU51(out1 *uint64, out2 *fiatFpUint1, arg1 fiatFpUint1, arg2 uint64, arg3 uint64) {
...
//   out1: [0x0 ~> 0x7ffffffffffff]
//   out2: [0x0 ~> 0x1]
func fiatFpSubborrowxU51(out1 *uint64, out2 *fiatFpUint1, arg1 fiatFpUint1, arg2 uint64, arg3 uint64) {
...
//
func fiatFpCarryMul(out1 *fiatFpTightFieldElement, arg1 *fiatFpLooseFieldElement, arg2 *fiatFpLooseFieldElement) {
	var x1 uint64
	var x2 uint64
...
//
func fiatFpCarrySquare(out1 *fiatFpTightFieldElement, arg1 *fiatFpLooseFieldElement) {
	x1 := (arg1[4] * 0x13)
	x2 := (x1 * 0x2)
	x3 := (arg1[4] * 0x2)
	x4 := (arg1[3] * 0x13)
...
//
func fiatFpCarry(out1 *fiatFpTightFieldElement, arg1 *fiatFpLooseFieldElement) {
	x1 := arg1[0]
	x2 := ((x1 >> 51) + arg1[1])
	x3 := ((x2 >> 51) + arg1[2])
	x4 := ((x3 >> 51) + arg1[3])
...
//   eval out1 mod m = (eval arg1 + eval arg2) mod m
//
func fiatFpAdd(out1 *fiatFpLooseFieldElement, arg1 *fiatFpTightFieldElement, arg2 *fiatFpTightFieldElement) {
	x1 := (arg1[0] + arg2[0])
	x2 := (arg1[1] + arg2[1])
	x3 := (arg1[2] + arg2[2])
	x4 := (arg1[3] + arg2[3])
...
//   eval out1 mod m = (eval arg1 - eval arg2) mod m
//
func fiatFpSub(out1 *fiatFpLooseFieldElement, arg1 *fiatFpTightFieldElement, arg2 *fiatFpTightFieldElement) {
...
//   eval out1 mod m = -eval arg1 mod m
//
func fiatFpOpp(out1 *fiatFpLooseFieldElement, arg1 *fiatFpTightFieldElement) {
...
//   eval out1 mod m = (eval arg1 + eval arg2) mod m
//
func fiatFpCarryAdd(out1 *fiatFpTightFieldElement, arg1 *fiatFpTightFieldElement, arg2 *fiatFpTightFieldElement) {
	x1 := (arg1[0] + arg2[0])
...
//   eval out1 mod m = (eval arg1 - eval arg2) mod m
//
func fiatFpCarrySub(out1 *fiatFpTightFieldElement, arg1 *fiatFpTightFieldElement, arg2 *fiatFpTightFieldElement) {
	x1 := ((0xfffffffffffda + arg1[0]) - arg2[0])
...
//   eval out1 mod m = -eval arg1 mod m
//
func fiatFpCarryOpp(out1 *fiatFpTightFieldElement, arg1 *fiatFpTightFieldElement) {
	x1 := (0xfffffffffffda - arg1[0])
...
//   out1 = arg1
//
func fiatFpRelax(out1 *fiatFpLooseFieldElement, arg1 *fiatFpTightFieldElement) {
	x1 := arg1[0]
	x2 := arg1[1]
	x3 := arg1[2]
	x4 := arg1[3]
...
func fiatFpSelectznz(out1 *[5]uint64, arg1 fiatFpUint1, arg2 *[5]uint64, arg3 *[5]uint64) {
	var x1 uint64
...
func fiatFpToBytes(out1 *[32]uint8, arg1 *fiatFpTightFieldElement) {
	var x1 uint64
	var x2 fiatFpUint1
...
func fiatFpFromBytes(out1 *fiatFpTightFieldElement, arg1 *[32]uint8) {

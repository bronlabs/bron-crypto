...
//
//   functions synthesised for this Montgomery arithmetic require the
//
...
type (
	fiat_pasta_fq_uint1 uint64 // We use uint64 instead of a more narrow type for performance reasons; see https://github.com/mit-plv/fiat-crypto/pull/1006#issuecomment-892625927
	fiat_pasta_fq_int1  int64  // We use uint64 instead of a more narrow type for performance reasons; see https://github.com/mit-plv/fiat-crypto/pull/1006#issuecomment-892625927
)
...
func fiat_pasta_fq_addcarryx_u64(x, y uint64, carry fiat_pasta_fq_uint1) (uint64, fiat_pasta_fq_uint1) {
...
func fiat_pasta_fq_subborrowx_u64(x, y uint64, carry fiat_pasta_fq_uint1) (uint64, fiat_pasta_fq_uint1) {
...
//	0 ≤ eval out1 < m
func fiat_pasta_fq_mul(out1, arg1, arg2 *fiat_pasta_fq_montgomery_domain_field_element) {
	x1 := arg1[1]
	x2 := arg1[2]
	x3 := arg1[3]
	x4 := arg1[0]
...
//	0 ≤ eval out1 < m
func fiat_pasta_fq_square(out1, arg1 *fiat_pasta_fq_montgomery_domain_field_element) {
	fiat_pasta_fq_mul(out1, arg1, arg1)
}
...
//	eval (from_montgomery out1) mod m = (eval (from_montgomery arg1) + eval (from_montgomery arg2)) mod m
//	0 ≤ eval out1 < m
func fiat_pasta_fq_add(out1, arg1, arg2 *fiat_pasta_fq_montgomery_domain_field_element) {
	var x1 uint64
...
//	eval (from_montgomery out1) mod m = (eval (from_montgomery arg1) - eval (from_montgomery arg2)) mod m
//	0 ≤ eval out1 < m
func fiat_pasta_fq_sub(out1, arg1, arg2 *fiat_pasta_fq_montgomery_domain_field_element) {
	var x1 uint64
	var x2 fiat_pasta_fq_uint1
...
//	0 ≤ eval out1 < m
func fiat_pasta_fq_opp(out1, arg1 *fiat_pasta_fq_montgomery_domain_field_element) {
	var x1 uint64
	var x2 fiat_pasta_fq_uint1
...
func fiat_pasta_fq_selectznz(out1 *[4]uint64, arg1 fiat_pasta_fq_uint1, arg2, arg3 *[4]uint64) {
	var x1 uint64
...
// The function fiat_pasta_fq_to_bytes serialises a field element NOT in the Montgomery domain to bytes in little-endian order.
//
// Preconditions:
//
//	0 ≤ eval arg1 < m

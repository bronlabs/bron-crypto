...
// Participant runs the Lindell17 two-party DKG rounds.
...
// State stores per-round secrets, commitments, and proof state.
...
// SharingID returns this participant's identifier.

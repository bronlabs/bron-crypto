...
// DNF represents a monotone access structure via minimal
...
func NewDNFAccessStructure(qualifiedSets ...ds.Set[ID]) (*DNF, error) {
...
func (d *DNF) IsQualified(ids ...ID) bool {

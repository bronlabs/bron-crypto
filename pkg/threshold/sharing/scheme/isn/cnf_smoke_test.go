...
func _[E algebra.GroupElement[E]]() {
	var (
		_ sharing.LinearShare[*isn.Share[E], ds.Map[bitset.ImmutableBitSet[sharing.ID], E], *additive.Share[E], E, algebra.Numeric, sharing.MonotoneAccessStructure] = (*isn.Share[E])(nil)
		_ sharing.LSSS[

...
func _[E algebra.PrimeGroupElement[E, S], S algebra.PrimeFieldElement[S]]() {
	var (
		...
		_ sharing.LSSS[*pedersen.Share[S], S, *pedersen.Secret[S], S, *pedersen.DealerOutput[E, S], S, *accessstructures.Threshold, *pedersen.DealerFunc[S]]  = (*pedersen.Scheme[E, S])(nil)
	)
}

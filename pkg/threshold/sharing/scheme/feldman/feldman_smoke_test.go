...
func _[E algebra.PrimeGroupElement[E, FE], FE algebra.PrimeFieldElement[FE]]() {
	var (
		...
		_ sharing.PolynomialLSSS[*feldman.Share[FE], FE, *feldman.Secret[FE], FE, *feldman.DealerOutput[E, FE], FE, *sharing.ThresholdAccessStructure]              = (*feldman.Scheme[E, FE])(nil)
	)
}

...
func DoDkgRound2(participants []*pedersen.Participant, round2BroadcastInputs []map[helper_types.IdentityHash]*pedersen.Round1Broadcast, round2UnicastInputs []map[helper_types.IdentityHash]*pedersen.Round1P2P) (signingKeyShares []*tsignatures.SigningKeyShare, publicKeyShares []*tsignatures.PublicKeyShares, err error) {

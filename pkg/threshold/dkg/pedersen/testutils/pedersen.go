...
func DoDkgRound1(participants []*pedersen.Participant, a_i0s []curves.Scalar) (round1BroadcastOutputs []*pedersen.Round1Broadcast, round1UnicastOutputs []network.RoundMessages[*pedersen.Round1P2P], err error) {
	round1BroadcastOutputs = make([]*pedersen.Round1Broadcast, len(participants))
	round1UnicastOutputs = make([]network.RoundMessages[*pedersen.Round1P2P], len(participants))
...
func DoDkgRound2(participants []*pedersen.Participant, round2BroadcastInputs []network.RoundMessages[*pedersen.Round1Broadcast], round2UnicastInputs []network.RoundMessages[*pedersen.Round1P2P]) (signingKeyShares []*tsignatures.SigningKeyShare, publicKeyShares []*tsignatures.PartialPublicKeys, err error) {

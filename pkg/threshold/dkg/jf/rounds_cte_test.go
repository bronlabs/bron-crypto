...
func Test_MeasureConstantTime_round2(t *testing.T) {
	...
	var r1OutsU []network.RoundMessages[*jf.Round1P2P]
...
func Test_MeasureConstantTime_round3(t *testing.T) {
	...
	var r1OutsB []*jf.Round1Broadcast
	var r1OutsU []network.RoundMessages[*jf.Round1P2P]
	var r2InsB []network.RoundMessages[*jf.Round1Broadcast]
	var r2InsU []network.RoundMessages[*jf.Round1P2P]
	var r2Outs []*jf.Round2Broadcast
	var r3Ins []network.RoundMessages[*jf.Round2Broadcast]

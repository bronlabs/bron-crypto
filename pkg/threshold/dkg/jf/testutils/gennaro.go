...
func DoDkgRound1(participants []*jf.Participant) (round1BroadcastOutputs []*jf.Round1Broadcast, round1UnicastOutputs []network.RoundMessages[*jf.Round1P2P], err error) {
	round1BroadcastOutputs = make([]*jf.Round1Broadcast, len(participants))
	round1UnicastOutputs = make([]network.RoundMessages[*jf.Round1P2P], len(participants))
...
func DoDkgRound2(participants []*jf.Participant, round2BroadcastInputs []network.RoundMessages[*jf.Round1Broadcast], round2UnicastInputs []network.RoundMessages[*jf.Round1P2P]) (round2Outputs []*jf.Round2Broadcast, err error) {
...
func DoDkgRound3(participants []*jf.Participant, round3Inputs []network.RoundMessages[*jf.Round2Broadcast]) (signingKeyShares []*tsignatures.SigningKeyShare, publicKeyShares []*tsignatures.PartialPublicKeys, err error) {

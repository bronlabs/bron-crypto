...
func DoDkgRound3(participants []*gennaro.Participant, round3Inputs []map[helper_types.IdentityHash]*gennaro.Round2Broadcast) (signingKeyShares []*tsignatures.SigningKeyShare, publicKeyShares []*tsignatures.PublicKeyShares, err error) {

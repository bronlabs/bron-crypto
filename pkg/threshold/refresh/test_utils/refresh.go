...
import (
	...
	"github.com/copperexchange/knox-primitives/pkg/threshold/refresh"
...
func DoDkgRound2(participants []*refresh.Participant, round2BroadcastInputs []map[helper_types.IdentityHash]*refresh.Round1Broadcast, round2UnicastInputs []map[helper_types.IdentityHash]*refresh.Round1P2P) (signingKeyShares []*tsignatures.SigningKeyShare, publicKeyShares []*tsignatures.PublicKeyShares, err error) {

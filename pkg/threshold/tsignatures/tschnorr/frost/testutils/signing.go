...
func DoInteractiveSignRound2(participants []*signing_helpers.Cosigner, round2Inputs []network.RoundMessages[*signing_helpers.Round1Broadcast], message []byte) (partialSignatures []*frost.PartialSignature, err error) {

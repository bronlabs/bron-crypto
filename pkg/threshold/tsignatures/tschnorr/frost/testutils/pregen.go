...
func DoPreGenRound2(participants []*noninteractive_signing.PreGenParticipant, round2Inputs []network.RoundMessages[types.ThresholdProtocol, *noninteractive_signing.Round1Broadcast]) ([]noninteractive_signing.PreSignatureBatch, [][]*noninteractive_signing.PrivateNoncePair, error) {
	var err error

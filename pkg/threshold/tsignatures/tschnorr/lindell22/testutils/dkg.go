...
func MakeParticipants(uniqueSessionId []byte, protocol types.ThresholdProtocol, identities []types.IdentityKey, prngs []io.Reader) (participants []*dkg.Participant, err error) {
...
func DoDkgRound3(participants []*dkg.Participant, round3Inputs []types.RoundMessages[*dkg.Round2Broadcast]) (shards []*lindell22.Shard, err error) {

...
func (p *PreGenParticipant) Round3(round2outputBroadcast network.RoundMessages[types.ThresholdSignatureProtocol, *signing.Round2Broadcast], round2outputP2P network.RoundMessages[types.ThresholdSignatureProtocol, *signing.Round2P2P]) (*dkls24.PreProcessingMaterial, error) {

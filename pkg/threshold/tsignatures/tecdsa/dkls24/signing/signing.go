...
func Aggregate(cipherSuite types.SigningSuite, publicKey curves.Point, partialSignatures network.RoundMessages[types.ThresholdSignatureProtocol, *dkls24.PartialSignature], message []byte) (*ecdsa.Signature, error) {

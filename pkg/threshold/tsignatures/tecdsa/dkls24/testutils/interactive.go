...
func MapPartialSignatures(identities []types.IdentityKey, partialSignatures []*dkls24.PartialSignature) network.RoundMessages[types.ThresholdSignatureProtocol, *dkls24.PartialSignature] {
	result := network.NewRoundMessages[types.ThresholdSignatureProtocol, *dkls24.PartialSignature]()
	for i, identity := range identities {

...
import (
	...
	noninteractiveSigning "github.com/copperexchange/krypton-primitives/pkg/threshold/tsignatures/tecdsa/dkls23/signing/noninteractive"
...
func RunPreGen(t *testing.T, parties []*noninteractiveSigning.PreGenParticipant) []*dkls23.PreProcessingMaterial {
	...
	r1ou := make([]network.RoundMessages[types.ThresholdSignatureProtocol, *signing.Round1P2P], len(parties))
	for i := range parties {

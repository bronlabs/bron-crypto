...
import (
	...
	"github.com/copperexchange/knox-primitives/pkg/threshold/tsignatures/tecdsa/dkls23/keygen/dkg"
)
...
func DoDkgRound2(participants []*dkg.Participant, round2BroadcastInputs []map[helper_types.IdentityHash]*dkg.Round1Broadcast, round2UnicastInputs []map[helper_types.IdentityHash]*dkg.Round1P2P) (round2BroadcastOutputs []*dkg.Round2Broadcast, round2UnicastOutputs []map[helper_types.IdentityHash]*dkg.Round2P2P, err error) {
	round2BroadcastOutputs = make([]*dkg.Round2Broadcast, len(participants))
	round2UnicastOutputs = make([]map[helper_types.IdentityHash]*dkg.Round2P2P, len(participants))
	for i := range participants {
...
func MapDkgRound2OutputsToRound3Inputs(participants []*dkg.Participant, round2BroadcastOutputs []*dkg.Round2Broadcast, round2UnicastOutputs []map[helper_types.IdentityHash]*dkg.Round2P2P) (round3BroadcastInputs []map[helper_types.IdentityHash]*dkg.Round2Broadcast, round3UnicastInputs []map[helper_types.IdentityHash]*dkg.Round2P2P) {
	round3BroadcastInputs = make([]map[helper_types.IdentityHash]*dkg.Round2Broadcast, len(participants))
	for i := range participants {
		round3BroadcastInputs[i] = make(map[helper_types.IdentityHash]*dkg.Round2Broadcast)
		for j := range participants {
			if j != i {
	...
	round3UnicastInputs = make([]map[helper_types.IdentityHash]*dkg.Round2P2P, len(participants))
	for i := range participants {
		round3UnicastInputs[i] = make(map[helper_types.IdentityHash]*dkg.Round2P2P)
		for j := range participants {
			if j != i {
...
func DoDkgRound3(participants []*dkg.Participant, round3BroadcastInputs []map[helper_types.IdentityHash]*dkg.Round2Broadcast, round3UnicastInputs []map[helper_types.IdentityHash]*dkg.Round2P2P) (round3UnicastOutputs []map[helper_types.IdentityHash]dkg.Round3P2P, err error) {
	round3UnicastOutputs = make([]map[helper_types.IdentityHash]dkg.Round3P2P, len(participants))
	for i := range participants {
...
func MapDkgRound3OutputsToRound4Inputs(participants []*dkg.Participant, round3UnicastOutputs []map[helper_types.IdentityHash]dkg.Round3P2P) (round4UnicastInputs []map[helper_types.IdentityHash]dkg.Round3P2P) {
	round4UnicastInputs = make([]map[helper_types.IdentityHash]dkg.Round3P2P, len(participants))
	for i := range participants {
		round4UnicastInputs[i] = make(map[helper_types.IdentityHash]dkg.Round3P2P)
		for j := range participants {
			if j != i {
...
func DoDkgRound4(participants []*dkg.Participant, round4UnicastInputs []map[helper_types.IdentityHash]dkg.Round3P2P) (round4UnicastOutputs []map[helper_types.IdentityHash]dkg.Round4P2P, err error) {
	round4UnicastOutputs = make([]map[helper_types.IdentityHash]dkg.Round4P2P, len(participants))
	for i := range participants {
...
func MapDkgRound4OutputsToRound5Inputs(participants []*dkg.Participant, round4UnicastOutputs []map[helper_types.IdentityHash]dkg.Round4P2P) (round5UnicastInputs []map[helper_types.IdentityHash]dkg.Round4P2P) {
	round5UnicastInputs = make([]map[helper_types.IdentityHash]dkg.Round4P2P, len(participants))
	for i := range participants {
		round5UnicastInputs[i] = make(map[helper_types.IdentityHash]dkg.Round4P2P)
		for j := range participants {
			if j != i {
...
func DoDkgRound5(participants []*dkg.Participant, round5UnicastInputs []map[helper_types.IdentityHash]dkg.Round4P2P) (round5UnicastOutputs []map[helper_types.IdentityHash]dkg.Round5P2P, err error) {
	round5UnicastOutputs = make([]map[helper_types.IdentityHash]dkg.Round5P2P, len(participants))
	for i := range participants {
...
func MapDkgRound5OutputsToRound6Inputs(participants []*dkg.Participant, round5UnicastOutputs []map[helper_types.IdentityHash]dkg.Round5P2P) (round6UnicastInputs []map[helper_types.IdentityHash]dkg.Round5P2P) {
	round6UnicastInputs = make([]map[helper_types.IdentityHash]dkg.Round5P2P, len(participants))
	for i := range participants {
		round6UnicastInputs[i] = make(map[helper_types.IdentityHash]dkg.Round5P2P)
		for j := range participants {
			if j != i {
...
func DoDkgRound6(participants []*dkg.Participant, round6UnicastInputs []map[helper_types.IdentityHash]dkg.Round5P2P) (shards []*dkls23.Shard, err error) {

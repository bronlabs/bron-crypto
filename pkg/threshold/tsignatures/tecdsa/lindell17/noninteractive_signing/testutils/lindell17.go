...
//}
//
//func MakePreGenParticipants(tau int, identities []types.IdentityKey, sid []byte, protocol types.PreSignedThresholdSignatureProtocol, allTranscripts []transcripts.Transcript) (participants []*noninteractive_signing.PreGenParticipant, err error) {
//	prng := crand.Reader
//	parties := make([]*noninteractive_signing.PreGenParticipant, len(identities))
//	for i := range identities {
//		parties[i], err = noninteractive_signing.NewPreGenParticipant(sid, allTranscripts[i], identities[i].(types.AuthKey), protocol, tau, prng)
//		if err != nil {
//			return nil, err
//		}
//	}
...
//}
//
//func DoPreGenRound3(participants []*noninteractive_signing.PreGenParticipant, input []types.RoundMessages[*noninteractive_signing.Round2Broadcast]) (output []*lindell17.PreSignatureBatch, err error) {
...
//}
//
//func DoLindell2017PreGen(participants []*noninteractive_signing.PreGenParticipant) (output []*lindell17.PreSignatureBatch, err error) {

...
func DoDkgRound2(participants []*lindell17_dkg.Participant, round2BroadcastInputs []network.RoundMessages[*lindell17_dkg.Round1Broadcast]) (round2Outputs []*lindell17_dkg.Round2Broadcast, err error) {
...
func DoDkgRound3(participants []*lindell17_dkg.Participant, round3Inputs []network.RoundMessages[*lindell17_dkg.Round2Broadcast]) (round3Outputs []*lindell17_dkg.Round3Broadcast, err error) {
...
func DoDkgRound4(participants []*lindell17_dkg.Participant, round4Inputs []network.RoundMessages[*lindell17_dkg.Round3Broadcast]) (round4Unicast []network.RoundMessages[*lindell17_dkg.Round4P2P], err error) {
	round4Outputs := make([]network.RoundMessages[*lindell17_dkg.Round4P2P], len(participants))
	for i := range participants {
...
func DoDkgRound5(participants []*lindell17_dkg.Participant, round5Inputs []network.RoundMessages[*lindell17_dkg.Round4P2P]) (round5Outputs []network.RoundMessages[*lindell17_dkg.Round5P2P], err error) {
	round5Outputs = make([]network.RoundMessages[*lindell17_dkg.Round5P2P], len(participants))
	for i := range participants {
...
func DoDkgRound6(participants []*lindell17_dkg.Participant, round6Inputs []network.RoundMessages[*lindell17_dkg.Round5P2P]) (round6Outputs []network.RoundMessages[*lindell17_dkg.Round6P2P], err error) {
	round6Outputs = make([]network.RoundMessages[*lindell17_dkg.Round6P2P], len(participants))
	for i := range participants {
...
func DoDkgRound7(participants []*lindell17_dkg.Participant, round7Inputs []network.RoundMessages[*lindell17_dkg.Round6P2P]) (round7Outputs []network.RoundMessages[*lindell17_dkg.Round7P2P], err error) {
	round7Outputs = make([]network.RoundMessages[*lindell17_dkg.Round7P2P], len(participants))
	for i := range participants {
...
func DoDkgRound8(participants []*lindell17_dkg.Participant, round8Inputs []network.RoundMessages[*lindell17_dkg.Round7P2P]) (shards []*lindell17.Shard, err error) {

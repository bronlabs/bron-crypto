...
func DoPreGenRound1(participants []*noninteractive_signing.PreGenParticipant) (output []network.RoundMessages[*noninteractive_signing.Round1Broadcast], err error) {
	result := make([]network.RoundMessages[*noninteractive_signing.Round1Broadcast], len(participants))
	for i := range participants {
		result[i] = network.NewRoundMessages[*noninteractive_signing.Round1Broadcast]()
	}
...
func DoPreGenRound2(participants []*noninteractive_signing.PreGenParticipant, input []network.RoundMessages[*noninteractive_signing.Round1Broadcast]) (output []network.RoundMessages[*noninteractive_signing.Round2Broadcast], err error) {
	result := make([]network.RoundMessages[*noninteractive_signing.Round2Broadcast], len(participants))
	for i := range participants {
		result[i] = network.NewRoundMessages[*noninteractive_signing.Round2Broadcast]()
	}
...
func DoPreGenRound3(participants []*noninteractive_signing.PreGenParticipant, input []network.RoundMessages[*noninteractive_signing.Round2Broadcast]) (output []*lindell17.PreProcessingMaterial, err error) {

...
func AggregateSignature(publicShard *trsa.PublicShard, partialSignatures ...*trsa.PartialSignature) (*saferith.Nat, error) {
...
func AggregatePKCS1v15Decryption(publicShard *trsa.PublicShard, partialDecryptions ...*trsa.PartialDecryption) ([]byte, error) {
	dealer1 := rep23.NewIntExpScheme(publicShard.N1)
	p1Shares := sliceutils.Map(partialDecryptions, func(s *trsa.PartialDecryption) *rep23.IntExpShare { return s.P1Share })
	...
	dealer2 := rep23.NewIntExpScheme(publicShard.N2)
	p2Shares := sliceutils.Map(partialDecryptions, func(s *trsa.PartialDecryption) *rep23.IntExpShare { return s.P2Share })
...
func AggregateOAEPDecryption(publicShard *trsa.PublicShard, cryptoHash crypto.Hash, label []byte, partialDecryptions ...*trsa.PartialDecryption) ([]byte, error) {
	dealer1 := rep23.NewIntExpScheme(publicShard.N1)
	p1Shares := sliceutils.Map(partialDecryptions, func(s *trsa.PartialDecryption) *rep23.IntExpShare { return s.P1Share })
	s1, err := dealer1.Open(p1Shares...)
	if err != nil {

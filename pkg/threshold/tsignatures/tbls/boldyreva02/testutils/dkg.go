...
func MapDkgRound1OutputsToRound2Inputs[K bls.KeySubGroup](participants []*dkg.Participant[K], round1BroadcastOutputs []*dkg.Round1Broadcast, round1UnicastOutputs []map[types.IdentityHash]*dkg.Round1P2P) (round2BroadcastInputs []map[types.IdentityHash]*dkg.Round1Broadcast, round2UnicastInputs []map[types.IdentityHash]*dkg.Round1P2P) {
...
func MapDkgRound2OutputsToRound3Inputs[K bls.KeySubGroup](participants []*dkg.Participant[K], round3Outputs []*dkg.Round2Broadcast) (round3Inputs []map[types.IdentityHash]*dkg.Round2Broadcast) {

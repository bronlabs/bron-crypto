...
func _[E algebra.PrimeGroupElement[E, FE], FE algebra.PrimeFieldElement[FE]]() {
	var (
		...
		// _ sharing.LSSS[*feldman.Share[FE], FE, *feldman.Secret[FE], FE, *feldman.DealerOutput[E, FE], *accessstructures.Threshold, feldman.DealerFunc[FE]]    = (*feldman.Scheme[E, FE])(nil)
	)
}

...
func _[E algebra.PrimeGroupElement[E, FE], FE algebra.PrimeFieldElement[FE]]() {
	var (
		_ sharing.LinearShare[*feldman.Share[FE], FE, algebra.Numeric] = (*feldman.Share[FE])(nil)
		...
		_ sharing.PolynomialLSSS[*feldman.Share[FE], FE, *feldman.Secret[FE], FE, *feldman.DealerOutput[E, FE], algebra.Numeric, *accessstructures.Threshold] = (*feldman.Scheme[E, FE])(nil)
	)
}

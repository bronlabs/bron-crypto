...
import (
	...
	dealer "github.com/bronlabs/bron-crypto/pkg/mpc/dkg/trusteddealer"
	...
	"github.com/bronlabs/bron-crypto/pkg/mpc/signatures/ecdsa/dkls23/signing_bbot"
...
func testHappyPath[P curves.Point[P, B, S], B algebra.PrimeFieldElement[B], S algebra.PrimeFieldElement[S]](t *testing.T, suite *ecdsa.Suite[P, B, S], accessStructure accessstructures.Monotone) {
	...
	baseShards, err := dealer.Deal(suite.Curve(), accessStructure, prng)
	require.NoError(t, err)

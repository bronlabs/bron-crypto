...
func DealBaseShards[G algebra.PrimeGroupElement[G, S], S algebra.PrimeFieldElement[S]](group algebra.PrimeGroup[G, S], accessStructure accessstructures.Monotone, prng io.Reader) (ds.Map[sharing.ID, *mpc.BaseShard[G, S]], error) {

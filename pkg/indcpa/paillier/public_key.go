...
func (pk *PublicKey) RandomNonce(prng io.Reader) (*Nonce, error) {
	if prng == nil {
	...
	for {
		...
		if err != nil {
			return nil, errs.NewRandomSample("cannot sample nonce")
		}
...
func (*PublicKey) CipherTextEqual(lhs, rhs *CipherText) bool {
	...
	return lhs.C.Eq(rhs.C) == 1
}

func (pk *PublicKey) CipherTextAdd(lhs, rhs *CipherText) (*CipherText, error) {
...
func (pk *PublicKey) CipherTextAddPlainText(lhs *CipherText, rhs *PlainText) (*CipherText, error) {
	if err := lhs.Validate(pk); err != nil {
		return nil, errs.WrapValidation(err, "invalid lhs")
	}
...
func (pk *PublicKey) CipherTextSub(lhs, rhs *CipherText) (*CipherText, error) {
	if err := lhs.Validate(pk); err != nil {
		return nil, errs.WrapValidation(err, "invalid lhs")
	}
	if err := rhs.Validate(pk); err != nil {
...
func (pk *PublicKey) CipherTextSubPlainText(lhs *CipherText, rhs *PlainText) (*CipherText, error) {
	if err := lhs.Validate(pk); err != nil {
		return nil, errs.WrapValidation(err, "invalid lhs")
	}
	if rhs == nil || !saferithUtils.NatIsLess(rhs, pk.N) {
...
func (pk *PublicKey) CipherTextMul(lhs *CipherText, rhs *Scalar) (*CipherText, error) {
	if err := lhs.Validate(pk); err != nil {
...
func (pk *PublicKey) CipherTextNeg(lhs *CipherText) (*CipherText, error) {
	if err := lhs.Validate(pk); err != nil {
		return nil, errs.WrapFailed(err, "invalid lhs")
	}
	...
	result := new(saferith.Nat).ModInverse(lhs.C, nnMod.GetModulus())
	if result == nil || result.EqZero() == 1 {
		return nil, errs.NewFailed("cannot compute inverse")
	}
...
func (pk *PublicKey) PlainTextAdd(lhs, rhs *PlainText) (*PlainText, error) {
	if lhs == nil || rhs == nil {
	...
	nMod, err := pk.GetNResidueParams()
	if err != nil {
		return nil, errs.WrapFailed(err, "cannot get residue params")
	}

	return new(saferith.Nat).ModAdd(lhs, rhs, nMod.GetModulus()), nil
}

func (pk *PublicKey) PlainTextSub(lhs, rhs *PlainText) (*PlainText, error) {
	if lhs == nil || rhs == nil {
		return nil, errs.NewIsNil("argument")
	}
	...
	return new(saferith.Nat).ModSub(lhs, rhs, nMod.GetModulus()), nil
}

func (pk *PublicKey) PlainTextNeg(lhs *PlainText) (*PlainText, error) {
	if lhs == nil {
		return nil, errs.NewIsNil("argument")
	}
	...
	return new(saferith.Nat).ModNeg(lhs, nMod.GetModulus()), nil
}

func (pk *PublicKey) PlainTextMul(lhs *PlainText, rhs *Scalar) (*PlainText, error) {
	if lhs == nil || rhs == nil {
		return nil, errs.NewIsNil("argument")
	}
	...
	return new(saferith.Nat).ModMul(lhs, rhs, nMod.GetModulus()), nil
}

func (pk *PublicKey) NonceAdd(lhs, rhs *Nonce) (*Nonce, error) {
	if lhs == nil || rhs == nil {
		return nil, errs.NewIsNil("argument")
	}
...
func (pk *PublicKey) NonceSub(lhs, rhs *Nonce) (*Nonce, error) {
	if lhs == nil || rhs == nil {
		return nil, errs.NewIsNil("argument")
	}
	...
	rhsInv := new(saferith.Nat).ModInverse(rhs, nMod.GetModulus())
	return new(saferith.Nat).ModMul(lhs, rhsInv, nMod.GetModulus()), nil
}

func (pk *PublicKey) NonceNeg(lhs *Nonce) (*Nonce, error) {
	if lhs == nil {
		return nil, errs.NewIsNil("argument")
	}
	...
	return new(saferith.Nat).ModInverse(lhs, nMod.GetModulus()), nil
}

func (pk *PublicKey) NonceMul(lhs *Nonce, rhs *Scalar) (*Nonce, error) {
	if lhs == nil || rhs == nil {
		return nil, errs.NewIsNil("argument")
	}
	...
	result, err := nMod.ModExp(lhs, rhs)
	if err != nil {
		return nil, errs.WrapFailed(err, "cannot compute exp")
	}
	return result, nil

...
type HomomorphicCiphertext[C Ciphertext[C], CV algebra.MonoidElement[CV], S algebra.UnsignedNumeric] interface {
	Ciphertext[C]
...
type HomomorphicScheme[
	...
	KG KeyGenerator[SK, PK], ENC Encrypter[PK, M, C, N], DEC Decrypter[M, C], S algebra.UnsignedNumeric,
...
type GroupHomomorphicScheme[
	...
	KG KeyGenerator[SK, PK], ENC LinearlyRandomisedEncrypter[PK, M, C, N], DEC Decrypter[M, C], S algebra.UnsignedNumeric,

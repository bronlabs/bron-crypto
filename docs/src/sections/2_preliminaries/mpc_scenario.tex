...
We do not make any assumption on the specifics of the controller set formation mechanism. We will leave this issue to the MPC platform and the particular Copper solution using this primitive. However, more often than not, these mechanisms require some identifier to be assigned to the participants, which has nothing to do with the primitive itself. We consider this and will require each participant to maintain a mapping from their protocol participant ID to their controller set ID.

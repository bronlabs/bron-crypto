...
\newcommand{\fndef}[2][]{{\fn{{#2}}\label{func:#1#2}}}                    % Function #2 with label #1#2
\newcommand{\fnref}[2][]{\fn{\hyperrefblk{func:#1#2}{#2}}}                % Function #2 with reference to #1#2
\newcommand{\idealfn}[2][]{\ensuremath{\mathcal{F}_{#1}^{#2}}}            % Ideal Function #1 for category #2
\newcommand{\idealfndef}[2][]{{\idealfn{{#2}}\label{idealfunc:#1#2}}}     % Ideal Function #2 with label #1#2
\newcommand{\idealfnref}[2][]{\idealfn{\hyperrefblk{idealfunc:#1#2}{#2}}} % Ideal Function #2 with reference to #1#2

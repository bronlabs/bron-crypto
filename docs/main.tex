...
%------------------------------HEADERS & VERSION-------------------------------%
    \input{src/headers/spec_header}
    \input{src/headers/spec_notation}
    
    \newcommand{\specversion}{Version 0.9}

%-----------------------------------TITLE--------------------------------------%
    \title{Copper's Threshold Signature Primitives \\(\specversion)}
...
\maketitle
\begin{abstract}
    This document contains the specification of the cryptographic protocols and primitives that serve as base for the Multi-Party Computation (MPC) platform of \href{https://copper.co}{Copper.co}. This specification serves a reference for the implementation of all the techniques described in it. 
...
\include{src/sections/1_introduction/1_introduction}

\input{src/sections/2_preliminaries/2_preliminaries}

\include{src/sections/3_signatures/3_signatures}

\include{src/sections/4_threshold_signatures/4_threshold_signatures}

\include{src/sections/5_tecdsa/5_tecdsa}

\include{src/sections/6_tschnorr/6_tschnorr}

\include{src/sections/7_tbls/7_tbls}
...
\appendix
\include{src/sections/appendix/appendix}

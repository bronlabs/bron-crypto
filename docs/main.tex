...
%-----------------------------------TITLE--------------------------------------%
    \title{Cryptographic Specification of Copper.co\\(\specversion)}
...
\input{src/sections/1_introduction/1_introduction}
\clearpage

\input{src/sections/2_preliminaries/2_preliminaries}
\clearpage

\input{src/sections/3_signatures/3_signatures}
\clearpage

\input{src/sections/4_threshold_signatures/4_threshold_signatures}
\clearpage

\input{src/sections/5_tecdsa/5_tecdsa}
\clearpage

\input{src/sections/6_tschnorr/6_tschnorr}
\clearpage

\input{src/sections/7_tbls/7_tbls}
\clearpage
...
\appendix
\input{src/sections/appendix/appendix}
